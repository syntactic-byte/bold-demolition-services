...
const allTranslations = {
  ...
  sv: {
    ...
    footer: {
      ...
      hours: { weekday: 'Mån-Fre: 07:00 - 18:00' },
    ...
    hero: {
      ...
      subtitle: 'RIVNING',
      description:
        'TitanBrytare är din pålitliga partner för professionellt rivningsarbete. Med mer än 25 års erfarenhet skapar vi utrymme för din framtid.',
    ...
    services: {
      ...
      moreInfo: 'Mer Info',
      description: 'Från köksrivning till komplett fastighetstömning - vi gör allt för hand.',
      manual: 'Manuell Rivning',
      manualDesc: 'Kvalificerat rivningsarbete med hammare och verktyg.',
      interior: 'Invändig Rivning',
      interiorDesc: 'Rivning av hus, kontor och butiker.',
      selective: 'Selektiv Rivning',
      selectiveDesc: 'Certifierad selektiv rivning av specifika delar.',
      asbestos: 'Asbets Avlägsnande',
      asbestosDesc: 'Certifierad asbetsborttagning enligt SC-530.',
      kitchenBathroom: 'Kök & Badrum',
      kitchenBathroomDesc: 'Specialiserad rivning av kök och badrum.',
      propertyClearing: 'Tömning',
      propertyClearingDesc: 'Komplett tömning av fastigheter.',
      kitchen: 'Kök & Badrum',
  ...
  pt: {
    ...
    cta: {
      ...
      contactToday:
        'Contacte-nos hoje para um orçamento gratuito. Respondemos ao seu pedido em 24 horas.',
    ...
    footer: {
      ...
      phone: '06-12345678',
      email: 'info@titanbreakers.nl',
      hours: { weekday: 'Seg-Sex: 07:00 - 18:00' },
    ...
    hero: {
      ...
      features: {
        ...
        certified: 'Certificado VCA',
        certifiedDesc: 'Padrões de segurança mais altos',
    ...
    services: {
      ...
      moreInfo: 'Mais Informações',
      description:
        'Desde a remoção de cozinhas até ao despejo completo - fazemos tudo manualmente.',
      ...
      interiorDesc: 'Remoção de casas, escritórios e lojas.',
      selective: 'Demolição Seletiva',
      selectiveDesc: 'Demolição certificada de partes específicas.',
      asbestos: 'Remoção de Amianto',
      asbestosDesc: 'Remoção certificada de amianto segundo SC-530.',
      kitchenBathroom: 'Cozinha & Casa de Banho',
      kitchenBathroomDesc: 'Demolição especializada de cozinhas e casas de banho.',
      propertyClearing: 'Despejo',
      propertyClearingDesc: 'Despejo completo de imóveis.',
    ...
    contact: {
      ...
      getInTouchDesc: 'Tem um projeto? Contacte-nos para um orçamento.',
