...
async function createTables() {
  ...
  try {
    ...
    await pool.query(`CREATE TABLE "about_page_stats" ("_order" INTEGER, "_parent_id" VARCHAR NOT NULL REFERENCES "about_page"("id") ON DELETE CASCADE, "id" VARCHAR PRIMARY KEY DEFAULT gen_random_uuid())`)
    await pool.query(`CREATE TABLE "about_page_stats_locales" ("_parent_id" VARCHAR NOT NULL REFERENCES "about_page_stats"("id") ON DELETE CASCADE, "_locale" VARCHAR NOT NULL, "label" JSONB, "number" VARCHAR, PRIMARY KEY ("_parent_id", "_locale"))`)
    ...
    await pool.query(`CREATE TABLE "about_page_timeline" ("_order" INTEGER, "_parent_id" VARCHAR NOT NULL REFERENCES "about_page"("id") ON DELETE CASCADE, "id" VARCHAR PRIMARY KEY DEFAULT gen_random_uuid())`)
    await pool.query(`CREATE TABLE "about_page_timeline_locales" ("_parent_id" VARCHAR NOT NULL REFERENCES "about_page_timeline"("id") ON DELETE CASCADE, "_locale" VARCHAR NOT NULL, "title" JSONB, "description" JSONB, "year" VARCHAR, PRIMARY KEY ("_parent_id", "_locale"))`)
    ...
    await pool.query(`CREATE TABLE "home_page_hero_stats" ("_order" INTEGER, "_parent_id" VARCHAR NOT NULL REFERENCES "home_page"("id") ON DELETE CASCADE, "id" VARCHAR PRIMARY KEY DEFAULT gen_random_uuid())`)
    await pool.query(`CREATE TABLE "home_page_hero_stats_locales" ("_parent_id" VARCHAR NOT NULL REFERENCES "home_page_hero_stats"("id") ON DELETE CASCADE, "_locale" VARCHAR NOT NULL, "label" JSONB, "number" VARCHAR, PRIMARY KEY ("_parent_id", "_locale"))`)
    ...
    await pool.query(`CREATE TABLE "contact_page_formSettings_subjects" ("_order" INTEGER, "_parent_id" VARCHAR NOT NULL REFERENCES "contact_page"("id") ON DELETE CASCADE, "id" VARCHAR PRIMARY KEY DEFAULT gen_random_uuid())`)
    await pool.query(`CREATE TABLE "contact_page_formSettings_subjects_locales" ("_parent_id" VARCHAR NOT NULL REFERENCES "contact_page_formSettings_subjects"("id") ON DELETE CASCADE, "_locale" VARCHAR NOT NULL, "label" JSONB, "value" VARCHAR, PRIMARY KEY ("_parent_id", "_locale"))`)
